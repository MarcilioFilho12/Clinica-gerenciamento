<template>
  <div class="w-full">
    ...
    <div class="relative">
      ...
      <input :id="inputId" :type="type" :value="currentValue" :placeholder="placeholder" :disabled="disabled"
...
export default {
  ...
  computed: {
    inputId() {
      return `base-input-${Math.random().toString(36).substr(2, 9)}`
    },
    // Suporta tanto Vue 2 (value) quanto Vue 3 (modelValue)
    currentValue() {
      // Prioriza modelValue (Vue 3), senão usa value (Vue 2)
